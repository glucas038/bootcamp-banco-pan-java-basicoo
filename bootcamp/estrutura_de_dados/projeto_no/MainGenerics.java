...
public class MainGenerics {
    public static void main(String[] args) {
        ...
        NoGenerics<String> noGenerics1 = new NoGenerics<>("Conteudo No1");

        NoGenerics<String> noGenerics2 = new NoGenerics<>("Conteudo No2");
        noGenerics1.setProximoNo(noGenerics2);

        NoGenerics<String> noGenerics3 = new NoGenerics<>("Conteudo No3");
        noGenerics2.setProximoNo(noGenerics3);

        NoGenerics noGenerics4 = new NoGenerics(4);
